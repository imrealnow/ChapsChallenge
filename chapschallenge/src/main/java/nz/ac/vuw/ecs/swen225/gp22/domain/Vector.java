...
/**
 * A Vector is a pair of Coordinates (x and y) used to denote the position of an Entity.
 * Contains a variety of helper functions to streamline the process of working with two different positions.
 */
record Vector(double x, double y){
     ...
     * @return A vector of this vectors old size, plus the x and y of the other vector.
     */
    ...
    /**
     * Similarly to scale, this function resizes a vector by the same amount in the x and y direction.
     * 
     * @param scale
