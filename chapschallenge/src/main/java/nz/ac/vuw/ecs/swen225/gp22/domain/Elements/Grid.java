...
public class Grid extends Tile implements Interactable {
     ...
     * 
     * A normal grid always returns false, as there is no way to step on a normal Grid (such as a wall)
     * This method should be overridden in more complicated Objects, such as Key Gates and the likes.
     */
   public boolean entityCanStep(Entity e){return false;}

   /**
     * Refer to Interactable for description.
     * 
     * This method has no body as nothing should happen when the player tries to stand on a normal grid.
     * This method should be overridden in more complicated Objects, such as Key Gates and the likes.
    */
